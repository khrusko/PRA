...
IF NOT EXISTS (SELECT ALL * FROM [dbo].[Books] WHERE [ISBN] = '978-9531-66701-3') BEGIN
  ...
  EXECUTE [dbo].[BookCreate] '978-9531-66701-3', 'Moj prijatelj Šišmiš', NULL, 'Izabrane dječje pjesme', 0, 11, 172, 40.00, 10.00, 14, NULL, @Authors, 1
END
GO
...
IF NOT EXISTS (SELECT ALL * FROM [dbo].[Books] WHERE [ISBN] = '978-9531-04987-3') BEGIN
  DECLARE @Authors AS [dbo].[Ids]
  INSERT INTO @Authors VALUES (6)
  EXECUTE [dbo].[BookCreate] '978-9531-04987-3', 'Priče iz davnine', NULL, 'Ove bajke autorici su donijele svjetsku slavu te je čak bila predložena za Nobelovu nagradu. U njima je autorica ispričala svoje umjetničke bajke u kojima je svojom maštom kombinirala realne i nestvarne događaje.', 0, 3, 265, 107.10, 25.10, 3, NULL, @Authors, 1
END
GO
